...
<div id="wraper" style="background-color: silver; height: 100px;" >
    ...
    <div style="float:top; margin-bottom: 22px;  margin-top: 8px;">
     ...
     <!--<iframe src="right.php" id="x" style="float: right; height:100%; width: 23%;  margin-top: 22px;" ></iframe>
      ...
      <a href="adm_add_all_courses_h.php" class="list-group-item" id="selected">المواد التي تدرس بالكلية<h4></h4></a>
      ...
      <script src="js/jquery-3.2.1.min.js"> </script>
        ...
        <div id="left">
        <iframe src="adm_add_all_courses.php"  style="position: fixed; left: 0px; width: 77%; height: 82%; " name="cont"></iframe>
        </div>
  </div>
