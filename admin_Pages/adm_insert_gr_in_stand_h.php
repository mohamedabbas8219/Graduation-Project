...
<div id="wraper" style="background-color: silver; height: 100px;" >
    ...
    <div style="float:top; margin-bottom: 22px;  margin-top: 10px;">
        
     <div style="float: right; width: 23%; ">
     <!--<iframe src="right.php" id="x" style="float: right; height:100%; width: 23%;  margin-top: 22px;" ></iframe>
      -->  
      <a href="Home.php"  class="list-group-item"  style="background-color: #8aa5ec; color: white;"><h4> إملأ البيانات </h4></a>
      ...
      <a href="adm_add_stand_h.php" class="list-group-item" id="selected"> اضافه المدرجات  </a>
     ...
     <div class="list-group-item" style="position:fixed; bottom: 12px; width: 23%; border-bottom-left-radius: 25% 100%; background-color: #8aa5ec;"></div>
      <script src="js/jquery-3.2.1.min.js"> </script>
        ...
        <div id="left">
            <iframe src="adm_insert_gr_in_stand.php"  style="position: fixed; left: 0px; width: 77%; height: 82%; " name="cont"></iframe>
        </div>
  </div>
