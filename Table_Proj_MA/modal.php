...
<body>
    ...
    <br />
       ...
       <div class="log_reg_home" style="top: 8px; right:25px; position:absolute;">
         <a href="#" data-toggle="modal" data-target="#myModal">Login Here</a>
          <b> |  </b>
...
$Days_n=array("Satarday","Sunday","Monday","Tuesday","Wednesday","Thursday","Friday");
 ...
 $Days[$Days_n[1]]["Lec3"]="nnnnnnnnnnnnnnn";
 $allocated_th=1;   // used inside for to  select allowed cells 
...
-->
  ...
  <div class="modal fade" id="myModalR" role="dialog">
    ...
    <!-- ####################################################################################################### -->
    <div class="footer" style=" background-color:slategray; color: #ffffff">
