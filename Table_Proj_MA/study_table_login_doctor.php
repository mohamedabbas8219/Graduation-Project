...
<center><span class="s">جداول المحاضرات</span></center>
   ...
   <?php include_once 'loginDrName.php';
?>
        </div> 
    ...
    <div> <center>
            <input class="btn" type="submit" value="مدرج 4 " name="submit4">
            <input class="btn" type="submit" value="مدرج 3 " name="submit3">
            <input class="btn" type="submit" value="مدرج 2 " name="submit2" onclick="window.open('study_table2.php', '_self')" >
             <input class="btn " type="submit" value="مدرج 1 " name="submit1">
             <br /></center>
</div>
...
$dr_name="";
 $a=$userData['username'];
 $p=$userData['password'];
$sql_drid = "SELECT dr_id, dr_fullname FROM doctors where username='.$a.' AND password='.$p.'";
...
///////////////////////////
 ...
 <?php
 ///////////////////////////////////////////////////////////   table first show
  $tablefill_sql="SELECT day,lec,s_group,dr_id,crs_id,done FROM doctor_course where stand='stand1' ORDER BY day,lec ";
 // echo $br.$br.'/////////////////////////////'.$br;
...
*/
 ...
 ///////////////////////////////////////////////////////////   table first show
   ...
   /* echo '  Show Table : '.$br.'    1   2   3   4   5   6'.$br.'    ';
    for($j=0;$j<count($fullArray);$j++)
    {
        echo $fullArray[$j].' , ';
         ...
         ?>
            ...
            <select name="sel_course" id="Course_name_rcv">
             ...
             <?php
              for($i=0,$ii=$crs_count;$i<$ii;$i++)
                {
                  echo " <option value='$coursesofdoc[$i]'>$coursesofdoc[$i]</option>";
...
<form  method="post" action="#here">
   ...
   <br />
    ...
    <input id="here" type="submit" onclick="reload()" class="btn" value="&nbsp; حفظ التعديل &nbsp;"   data-dismiss="modal" style="width: 160px;" />
</form>
         ...
         if($modified_day!=null||$modified_lec!=null||$crs_realnum!=0)
             {
               $close_cell_q = "UPDATE coursesofdoctor SET alocated=$dr_id WHERE dr_id=$dr_id and crs_id=$crs_realnum";
                ...
                $update_cell_q = "UPDATE doctor_course SET dr_id=$dr_id,crs_id=$crs_realnum,done=$dr_id WHERE stand='stand1' and day=$modified_day and lec=$modified_lec";
...
// $update = "UPDATE doctor_course SET dr_id=$dr_id ,crs_id=2 , done=$dr_id WHERE stand='stand1' and day=4 and lec=3";
//
